...
#| echo: false
#| output: false
modelpath = joinpath(_models_path, "sdm-steps.jld2")
...
#| echo: false
#| output: false
C0v, C0t = crossvalidate(model, folds)
reset!(model)
CXv, CXt = crossvalidate(model, folds)
```
...
#| tbl-cap: Consequences of different variable selection approaches on the performance of the model, as evaluated by the MCC. 
tbl = []
...
#| echo: false
modelpath = joinpath(_models_path, "sdm-steps.jld2")
JLD2.jldopen(modelpath, "a+") do file
    file["01-optimalvariables"] = finalmodel
end
```