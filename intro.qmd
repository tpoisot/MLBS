...
In @sec-confusion, we will explore additional ways in which we can refine the contents of our confusion matrix, either to reflect the reality of our data, or to emphasize some priorities when making predictions.
