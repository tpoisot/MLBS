# Testing, training, validating {#sec-splits}
...
: gfkdf jdshgl dsjg d. Information in the "Data used for training" column refer to the data that have been used to train the model when calculating its performance. {#tbl-splits-models}
...
{{< embed ../notebooks/sm-splits.qmd#fig-splits-performance >}}
...
{{< embed ../notebooks/sm-splits.qmd#tbl-splits-performance-summary >}}
...
### Is our model good, then? {#sec-splits-fitness}
