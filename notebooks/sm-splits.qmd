...
We will add a little cell to output the table in a way we can use in the main document -- if you run this line from the terminal, this will very likely fail.
