...
fig = Figure(resolution=(500,300))
ax = Makie.Axis(fig[1,1]; xlabel="Vegetation", ylabel="Moisture")
scatter!(ax, vec(ndvi), vec(ndmi), color=clusters.assignments, colormap=Makie.wong_colors())
tightlimits!(ax)
current_figure()
```
...
#| fig-cap: Summary of the values for the centers of the optimal clusters found in this image.
df = DataFrame()
