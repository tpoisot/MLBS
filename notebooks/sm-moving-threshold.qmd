...
for i in axes(confvalid, 3)
    lines!(roc, raw_fpr[i,:], raw_tpr[i,:], color=(:black, 0.1ylims!(ax, low=0.0, high=1.0)))
...
bio1 = SpeciesDistributionToolkit._read_geotiff("data/general/rangifer-layers.tiff", SimpleSDMResponse; bandnumber=1)
bio2 = SpeciesDistributionToolkit._read_geotiff("data/general/rangifer-layers.tiff", SimpleSDMResponse; bandnumber=2)
bio15 = SpeciesDistributionToolkit._read_geotiff("data/general/rangifer-layers.tiff", SimpleSDMResponse; bandnumber=15)
```
