...
model = SDM(RawData(), NBC(), 0.5, X, y, v0)
...
#| echo: false
#| output: false
folds = kfold(y, X; k=15, permute=true)
...
reset!(model)
i0 = predictors(stepwisevif!(model, 10.0; threshold=false))
...
JLD2.jldsave(modelpath; transformation=typeof(finalmodel.transformer), variables=finalmodel.v, folds = folds)
```