...
#| echo: false
#| output: false
conftrain = zeros(ConfusionMatrix, 1000)
...
#| echo: false
#| output: false
_layer_path = joinpath(dirname(Base.active_project()), "data", "general", "rangifer-layers.tiff")
...
surface!(ax, pr.>0.5, shading=false, colormap=[:lightgrey, :black], interpolate=false)
ax.xticklabelpad = 30
ax.yticklabelpad = 40
current_figure()
```
