...
::: content-margin
A counter-example where performing the transformation *before* the analysis is when the transformation is explicitely sought out as an embedding, where we want to predict the position of instances in the embedded space, as in *.e.g.*@runghen2022.
:::
