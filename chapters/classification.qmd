...
### The accuracy paradox {#sec-classification-accuracy}
...
heatmap!(ax1, pr.>0.5, shading=false, colormap=vibrant[1:2], interpolate=false)
sf = heatmap!(ax2, un, shading=false, colormap=cgrad(iridescent), interpolate=false)

heatmap!(ax0, pr, colormap=[:black, :black], shading=false, interpolate=false)
