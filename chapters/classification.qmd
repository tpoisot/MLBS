...
fmat = [(mcc, "Matthew's corr. coeff."), (ppv, "Positive pred. val."), (npv, "Negative pred. val."), (tpr, "True pos. rate"), (tpr, "True neg. rate"), (balancedaccuracy, "Bal. acc."), (accuracy, "Accuracy")]
fig = Figure(; size=(700, 300))

ax = Axis(fig[1,1], xlabel="Measure")
...
fig[1,2] = Legend(fig, ax, merge=true, unique=true)
