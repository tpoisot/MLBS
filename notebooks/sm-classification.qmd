...
hist!(ax1, 0.1filter(r -> r.presence, train).bio1, color=(c, 0.3), strokecolor=c, strokewidth=1, normalization=:pdf)

ax2 = Axis(f[2,1])
c = Makie.wong_colors()[2]
hist!(ax2, 0.1filter(r -> !r.presence, train).bio1, color=(c, 0.3), strokecolor=c, strokewidth=1, normalization=:pdf)
