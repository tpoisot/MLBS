...
#| echo: false
#| output: false
R = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B4.tif"), SimpleSDMResponse)
G = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B3.tif"), SimpleSDMResponse)
B = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B2.tif"), SimpleSDMResponse)
NIR = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B5.tif"), SimpleSDMResponse)
SWIR1 = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B6.tif"), SimpleSDMResponse)
SWIR2 = SpeciesDistributionToolkit._read_geotiff(joinpath(_data_path, "earthengine", "LandSat.B7.tif"), SimpleSDMResponse)
```
...
X[1,:] .= values(mask(msk, NDVI))
X[2,:] .= values(mask(msk, NDWI))
X[3,:] .= values(mask(msk, NDMI))
X[4,:] .= values(mask(msk, NBR))
```
