...
push!(tbl, "\n: Model performance when coupling variable selection with variable transformation. The measures of performance are given as in @tbl-predictions-selection, and as we use the same folds for validation, can be directly compared. {#tbl-predictors-transformation}")
try
    display("text/markdown", join(tbl, "\n"))
catch e
end
