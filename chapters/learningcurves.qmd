...
c = 1.96 .* σ ./ sqrt(_repls)
band!(ax1, _prop, μ-c, μ+c, color = (crosscolors.training, 0.4))
scatterlines!(ax1, _prop, μ, color = crosscolors.training, markersize=4, linewidth=1)
