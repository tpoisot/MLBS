# Gradient descent {#gradientdescent-gradientdescent-gradientdescent-gradientdescent-sec-gradientdescent}
...
## A digression: what is a trained model? {#gradientdescent-gradientdescent-gradientdescent-sec-gradientdescent-trainedmodel}

## The problem: how many interactions in a food web? {#gradientdescent-gradientdescent-gradientdescent-sec-gradientdescent-problem}
...
| Mean Absolute Error (MAE, L1) | $\frac{1}{n}\sum_{i=1}^{n}\|y_i - \hat y_i\|$               |                                                                                      |
...
Throughout this chapter, we will use the L2 loss (@eq-loss-mse), because of **TK** nice properties to demo
