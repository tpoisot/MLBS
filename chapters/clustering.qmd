...
scatter!(ax, values(mask(msk, NDVI)), values(mask(msk, NDMI)), color=clusters.assignments, colormap=bkcol.cat, markersize=2)
tightlimits!(ax)
current_figure()
```
