...
prds = predict(model; threshold=false)
scatter!(ax, [prds[2]-mean(prds)], [1], color=:transparent, strokecolor=:red, strokewidth=3, markersize=15)
current_figure()
```
...
var_colors = cgrad(:diverging_rainbow_bgymr_45_85_c67_n256, length(variables(model)), categorical=true)
