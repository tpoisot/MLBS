...
These two predictors are important for plants [@clapham1935] or animals [@whittaker1962] **ECOZONES**, and see *e.g.* climate change [@berteaux2014]

data from [@fick2017], an alternative is [@karger2017] which is higher resolution, so for iteration we work with a smaller data product
